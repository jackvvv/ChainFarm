package sinia.com.linkfarm.city;
...
public class CityPicker extends LinearLayout {
    ...
    private String province, city, couny;
    ...
    protected void onFinishInflate() {
        ...
        LayoutInflater.from(getContext()).inflate(R.layout.view_city_picker,
                this);
    ...
    public String getCouny() {
        couny = counyPicker.getSelectedText();
        return couny;
    }
