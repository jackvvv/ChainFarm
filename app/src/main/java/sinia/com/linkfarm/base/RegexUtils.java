...
public final class RegexUtils {  
     ...
     *
     */
    public static boolean checkUpwardLetter(String str) {
        String regex = "^[A-Z]+$";
        return Pattern.matches(regex, str);
    }
    /**
     ...
     *
     */
    public static boolean checkLowerLetter(String str) {
        String regex = "^[a-z]+$";
        return Pattern.matches(regex, str);
    }
    /**
    ...
    /**
    *
    * 匹配用户名3-15位数字英文下划线，不以下划线开头
    *
    */
    public static boolean checkUsername(String username) {
		String regex = "^(?!_)(?!.*?_$)[a-zA-Z0-9_]{3,15}$";
